 ...
 * Auto-generated by https://idss.vercel.app/api/skill
 *
 * Connects OpenClaw to the IDSS AI shopping backend.
 * Works with WhatsApp, iMessage, Telegram, Discord, Slack, Signal.
 *
 * Install: tell OpenClaw "Install this skill from URL: ${process.env.NEXT_PUBLIC_SITE_URL || 'https://idss.vercel.app'}/api/skill"
 */

const IDSS_API_URL = '${apiUrl}';
